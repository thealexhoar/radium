...
fn main() {
    ...
    let mut glyphbatch:GlyphBatch = GlyphBatch::new(glyphset, 40, 30, 800, 600);

    glyphbatch.drawtarget.set_tiles_rect(Some(Tile::new(Some(Color::white()), Some(Color::new_from_rgb(10,10,55)), 225)), 5, 3, 22, 10);

    glyphbatch.drawtarget.draw_string_slice("Hello World!", 5, 2, Color::black(), Some(Color::cyan()));
